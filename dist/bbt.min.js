 ...
 * MIT licence
 */
var hexcase=0,b64pad="=";function hex_md5(a){return rstr2hex(rstr_md5(str2rstr_utf8(a)))}function b64_md5(a){return rstr2b64(rstr_md5(str2rstr_utf8(a)))}function any_md5(a,d){return rstr2any(rstr_md5(str2rstr_utf8(a)),d)}function hex_hmac_md5(a,d){return rstr2hex(rstr_hmac_md5(str2rstr_utf8(a),str2rstr_utf8(d)))}function b64_hmac_md5(a,d){return rstr2b64(rstr_hmac_md5(str2rstr_utf8(a),str2rstr_utf8(d)))}
function any_hmac_md5(a,d,b){return rstr2any(rstr_hmac_md5(str2rstr_utf8(a),str2rstr_utf8(d)),b)}function md5_vm_test(){return"900150983cd24fb0d6963f7d28e17f72"==hex_md5("abc").toLowerCase()}function rstr_md5(a){return binl2rstr(binl_md5(rstr2binl(a),8*a.length))}
...
function rstr2any(a,d){var b=d.length,e,f,g,h,n,p=Array(Math.ceil(a.length/2));for(e=0;e<p.length;e++)p[e]=a.charCodeAt(2*e)<<8|a.charCodeAt(2*e+1);var x=Math.ceil(8*a.length/(Math.log(d.length)/Math.log(2))),s=Array(x);for(f=0;f<x;f++){n=[];for(e=h=0;e<p.length;e++)if(h=(h<<16)+p[e],g=Math.floor(h/b),h-=g*b,0<n.length||0<g)n[n.length]=g;s[f]=h;p=n}b="";for(e=s.length-1;0<=e;e--)b+=d.charAt(s[e]);return b}
...
e,f,g,a[h+4],6,-145523070),g=md5_ii(g,b,e,f,a[h+11],10,-1120210379),f=md5_ii(f,g,b,e,a[h+2],15,718787259),e=md5_ii(e,f,g,b,a[h+9],21,-343485551),b=safe_add(b,n),e=safe_add(e,p),f=safe_add(f,x),g=safe_add(g,s);return[b,e,f,g]}function md5_cmn(a,d,b,e,f,g){return safe_add(bit_rol(safe_add(safe_add(d,a),safe_add(e,g)),f),b)}function md5_ff(a,d,b,e,f,g,h){return md5_cmn(d&b|~d&e,a,d,f,g,h)}function md5_gg(a,d,b,e,f,g,h){return md5_cmn(d&e|b&~e,a,d,f,g,h)}
function md5_hh(a,d,b,e,f,g,h){return md5_cmn(d^b^e,a,d,f,g,h)}function md5_ii(a,d,b,e,f,g,h){return md5_cmn(b^(d|~e),a,d,f,g,h)}function safe_add(a,d){var b=(a&65535)+(d&65535);return(a>>16)+(d>>16)+(b>>16)<<16|b&65535}function bit_rol(a,d){return a<<d|a>>>32-d};(function(a){function d(a,d,u){var z=0,A=[0],v="",k=null,v=u||"UTF8";if("UTF8"!==v&&"UTF16"!==v)throw"encoding must be UTF8 or UTF16";if("HEX"===d){if(0!==a.length%2)throw"srcString of HEX type must be in byte increments";k=e(a);z=k.binLen;A=k.value}else if("ASCII"===d||"TEXT"===d)k=b(a,v),z=k.binLen,A=k.value;else if("B64"===d)k=f(a),z=k.binLen,A=k.value;else throw"inputFormat must be HEX, TEXT, ASCII, or B64";this.getHash=function(a,b,d,e){var f=null,t=A.slice(),u=z,v;3===arguments.length?"number"!==
...
"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(h>>>6*(3-g)&63):d+b.b64Pad;return d}function n(a){var b={outputUpper:!1,b64Pad:"="};try{a.hasOwnProperty("outputUpper")&&(b.outputUpper=a.outputUpper),a.hasOwnProperty("b64Pad")&&(b.b64Pad=a.b64Pad)}catch(d){}if("boolean"!==typeof b.outputUpper)throw"Invalid outputUpper formatting option";if("string"!==typeof b.b64Pad)throw"Invalid b64Pad formatting option";return b}function p(a,b){return a<<b|a>>>32-b}function x(a,b,d){return a^
b^d}function s(a,b,d){return a&b^~a&d}function H(a,b,d){return a&b^a&d^b&d}function I(a,b){var d=(a&65535)+(b&65535);return((a>>>16)+(b>>>16)+(d>>>16)&65535)<<16|d&65535}function J(a,b,d,e,f){var g=(a&65535)+(b&65535)+(d&65535)+(e&65535)+(f&65535);return((a>>>16)+(b>>>16)+(d>>>16)+(e>>>16)+(f>>>16)+(g>>>16)&65535)<<16|g&65535}function w(a,b){var d=[],e,f,g,h,n,w,F=s,C=x,G=H,y=p,m=I,r,l,B=J,D,q=[1732584193,4023233417,2562383102,271733878,3285377520];a[b>>>5]|=128<<24-b%32;a[(b+65>>>9<<4)+15]=b;D=a.length;
for(r=0;r<D;r+=16){e=q[0];f=q[1];g=q[2];h=q[3];n=q[4];for(l=0;80>l;l+=1)d[l]=16>l?a[l+r]:y(d[l-3]^d[l-8]^d[l-14]^d[l-16],1),w=20>l?B(y(e,5),F(f,g,h),n,1518500249,d[l]):40>l?B(y(e,5),C(f,g,h),n,1859775393,d[l]):60>l?B(y(e,5),G(f,g,h),n,2400959708,d[l]):B(y(e,5),C(f,g,h),n,3395469782,d[l]),n=h,h=g,g=y(f,30),f=e,e=w;q[0]=m(e,q[0]);q[1]=m(f,q[1]);q[2]=m(g,q[2]);q[3]=m(h,q[3]);q[4]=m(n,q[4])}return q}"function"===typeof define&&typeof define.amd?define(function(){return d}):"undefined"!==typeof exports?
"undefined"!==typeof module&&module.exports?module.exports=exports=d:exports=d:a.jsSHA=d})(this);BBT=function(a,d){checkAppKey(a);this.key=a;d=d||{};this.initDefaults();this.updateParams(d);this.instanceID=Math.floor(1E9*Math.random());BBT.instances.push(this);this.connection=new BBT.Connection(this);this.connect()};BBT.VERSION="0.1.0";BBT.PROTO=1;BBT.ws_host="ws.beebotte.com";BBT.api_host="api.beebotte.com";BBT.host="beebotte.com";BBT.port=80;BBT.sport=443;
...
BBT.prototype.updateParams=function(a){a.auth_endpoint&&(this.auth_endpoint=a.auth_endpoint);a.auth_method&&(this.auth_method=a.auth_method);a.username&&(this.userinfo.username=a.username);a.host&&(this.host=a.host);a.ws_host&&(this.ws_host=a.ws_host);a.api_host&&(this.api_host=a.api_host);a.port&&(this.port=a.port);a.sport&&(this.sport=a.sport);a.ssl&&(this.ssl=a.ssl);a.cipher&&(this.cipher=a.cipher)};
BBT.prototype.getWsUrl=function(){return(!0===this.ssl?"https://":"http://")+this.ws_host+":"+(!0===this.ssl?this.sport:this.port)};BBT.prototype.getApiUrl=function(){return(!0===this.ssl?"https://":"http://")+this.api_host+":"+(!0===this.ssl?this.sport:this.port)};BBT.Connection=function(a){this.bbt=a;this.connected=!1;this.connection=null;this.channels=new BBT.Channels};BBT.Connection.prototype.onConnection=function(){this.connected=!0;for(c in this.channels.channels)this.channels.channels[c].do_subscribe()};
BBT.Connection.prototype.connect=function(){var a=this,d="key="+this.bbt.key+"&username="+(a.bbt.userinfo.username||"");this.connection=new io.connect(a.bbt.getWsUrl(),{query:d});this.connection.on("connect",function(){a.connected=!0;a.onConnection()});this.connection.on("disconnect",function(){a.connected=!1});this.connection.on("message",function(b){if(b.channel&&b.resource){var d=a.channels.get(b.channel,b.resource);d&&d.fct(b)}})};
BBT.Connection.prototype.disconnect=function(){this.connection&&this.connection.socket.disconnect()};BBT.Connection.prototype.get_auth=function(a,d){var b=this;b.connected&&b.bbt.auth_endpoint&&b.connection&&b.connection.socket&&b.connection.socket.sessionid&&$.get(b.bbt.auth_endpoint,{sid:b.connection.socket.sessionid,channel:a||"",resource:d||""}).success(function(e){b.send_auth(e,{channel:a,resource:d})}).error(function(a,b,d){})};
BBT.Connection.prototype.send_auth=function(a,d){return this.send("control","authenticate",{auth:a.auth,source:d})?this.authenticated=!0:this.authenticated=!1};BBT.Connection.prototype.subscribe=function(a,d){var b=this.channels.get(a.channel,a.resource);b?b.update(a,d):(b=new BBT.Channel(a,d,this.bbt),this.channels.add(b),b.do_subscribe())};
BBT.Connection.prototype.unsubscribe=function(a){var d=this.channels.get(a.channel,a.resource);return d?(d.unsubscribe(),this.send("control","unsubscribe",{channel:a.channel,resource:a.resource})):!0};
...
BBT.Connection.prototype.write=function(a){var d=this.channels.getChannelWithPermission(a.channel,a.resource,!1,!0);0===a.channel.indexOf("private-")&&(a.channel=a.channel.substring(8));return d&&d.hasWritePermission()?this.send("stream","write",{channel:a.channel,resource:a.resource,data:a.data})?a.callback(null,{code:0}):a.callback({code:11,message:"Error while writing message!"}):a.callback({code:11,message:"Permission error: cant't write on the given resource!"})};
BBT.Connection.prototype.send=function(a,d,b){return this.connection?(this.connection.json.send({version:BBT.PROTO,channel:a,event:d,data:b}),!0):!1};BBT.Channels=function(){this.channels=[]};BBT.Channels.prototype.all=function(){return this.channels};BBT.Channels.prototype.add=function(a){this.channels[a.eid]=a};BBT.Channels.prototype.get=function(a,d){return this.channels[a+"."+d]?this.channels[a+"."+d]:null};
BBT.Channels.prototype.getAny=function(a,d){return this.channels[a+"."+d]?this.channels[a+"."+d]:this.channels[a+".*"]?this.channels[a+".*"]:null};BBT.Channels.prototype.getChannelWithPermission=function(a,d,b,e){var f=null,g=!1;if(f=this.channels[a+"."+d]){if(g=!0,b&&(g=f.hasReadPermission()),e&&(g=f.hasWritePermission()),g)return f}else if(f=this.channels[a+".*"])if(g=!0,b&&(g=f.hasReadPermission()),e&&(g=f.hasWritePermission()),g)return f;return null};
BBT.Channel=function(a,d,b){this.eid=a.channel+"."+a.resource;this.channel=a.channel;this.resource=a.resource;this.bbt=b;this.fct=d;this.subscribed=!1;this.write=a.write||!1;this.read=a.read||!1;this.readPermission=this.writePermission=!1;this.onError=a.onError;this.onSuccess=a.onSuccess};BBT.Channel.prototype.update=function(a){};BBT.Channel.prototype.authNeeded=function(){return!0===this.write||0===this.channel.indexOf("private-")||0===this.channel.indexOf("presence-")?!0:!1};
BBT.Channel.prototype.do_subscribe=function(){var a=this;if(a.bbt.connection.connected){var d=this.bbt.connection,b={};b.channel=a.channel;b.resource=a.resource||"*";b.ttl=b.ttl||0;b.read=a.read;b.write=a.write;if(this.authNeeded()){if(!a.bbt.auth_endpoint)return a.onError("Authentication error: Missing authentication endpoint!");if(d.connected&&d.connection&&d.connection.socket&&d.connection.socket.sessionid)if(b.sid=d.connection.socket.sessionid,"get"===d.bbt.auth_method)$.get(d.bbt.auth_endpoint,
b).success(function(e){if(!e.auth)return a.onError("Bad authentication reply");b.sig=e.auth;return d.send("control","subscribe",b)?(a.subscribe(),a.onSuccess("Successfully subscribed to "+a.channel+"."+a.resource),!0):!1}).error(function(b,d,g){return a.onError("Unable to authenticate client")});else if("post"===d.bbt.auth_method)$.post(d.bbt.auth_endpoint,b).success(function(e){if(!e.auth)return a.onError("Bad authentication reply");b.sig=e.auth;return d.send("control","subscribe",b)?(a.subscribe(),
a.onSuccess("Successfully subscribed to "+a.channel+"."+a.resource),!0):!1}).error(function(b,d,g){return a.onError("Unable to authenticate client")});else{if("fct"===d.bbt.auth_method){sig=d.bbt.auth_endpoint(b.sid,b.channel,b.resource,b.ttl,b.read,b.write);if(!sig)return a.onError("Unable to authenticate client");b.sig=sig.auth;return d.send("control","subscribe",b)?(a.subscribe(),a.onSuccess("Successfully subscribed to "+a.channel+"."+a.resource),!0):!1}return a.onError("Unsupported authentication method!")}else return a.onError("Connection error encountered")}else return d.send("control",
"subscribe",b)?(a.subscribe(),a.onSuccess("Successfully subscribed to "+a.channel+"."+a.resource),!0):!1}};BBT.Channel.prototype.setReadPermission=function(){this.read=this.readPermission=!0};BBT.Channel.prototype.setWritePermission=function(){this.write=this.writePermission=!0};BBT.Channel.prototype.resetReadPermission=function(){this.read=this.readPermission=!1};BBT.Channel.prototype.resetWritePermission=function(){this.write=this.writePermission=!1};
BBT.Channel.prototype.subscribe=function(){this.subscribed=!0;!0===this.read&&this.setReadPermission();!0===this.write&&this.setWritePermission()};BBT.Channel.prototype.unsubscribe=function(){this.subscribed=!1;this.resetReadPermission();this.resetWritePermission()};BBT.Channel.prototype.hasWritePermission=function(){return this.writePermission};BBT.Channel.prototype.hasReadPermission=function(){return this.readPermission};
function checkAppKey(a){null!==a&&void 0!==a||BBT.warn("Warning: You must pass your key id when you instantiate BBT.")}BBT.warn=function(a){window.console&&(window.console.warn?window.console.warn(a):window.console.log&&window.console.log(a));BBT.log&&BBT.log(a)};BBT.error=function(a){if(BBT.debug)throw Error(msg);};BBT.prototype.setUsername=function(a){this.userinfo.username=a};
BBT.prototype.connect=function(){this.connection.connection?(this.connection.connection.socket.options.query="key="+this.key+"&username="+(this.userinfo.username||""),this.connection.connection.socket.reconnect()):this.connection.connect()};BBT.prototype.disconnect=function(){this.connection.disconnect()};
BBT.prototype.publish=function(a,d){var b={};b.channel=a.channel;b.resource=a.resource;b.data=a.data||d;b.callback=a.callback||function(){};return b.channel?b.resource?"string"!==typeof b.channel?BBT.error("Invalid format: channel must be a string"):"string"!==typeof b.resource?BBT.error("Invalid format: resource must be a string"):b.data?this.connection.publish(b):BBT.error("Data message not specified"):BBT.error("resource not specified"):BBT.error("channel not specified")};
BBT.prototype.write=function(a,d){var b={};b.channel=a.channel;b.resource=a.resource;b.data=a.data||d;b.callback=a.callback||function(){};return b.channel?b.resource?b.data?"string"!==typeof b.channel?BBT.error("Invalid format: channel must be a string"):"string"!==typeof b.resource?BBT.error("Invalid format: resource must be a string"):this.connection.write(b):BBT.error("Data message not specified"):BBT.error("resource not specified"):BBT.error("channel not specified")};
BBT.prototype.subscribe=function(a,d){var b={},e=d||a.callback;b.channel=a.channel;b.resource=a.resource||"*";b.ttl=a.ttl||0;b.read=a.read||!0;b.write=!0===a.write;b.onError=a.onError||BBT.warn;b.onSuccess=a.onSuccess||function(){};var f=b.onError;return b.channel?"string"!==typeof b.channel?f("Invalid format: channel must be a string"):"string"!==typeof b.resource?f("Invalid format: resource must be a string"):"number"!==typeof b.ttl?f("Invalid format: ttl must be a number"):"boolean"!==typeof b.read?
f("Invalid format: read element must be boolean"):"boolean"!==typeof b.write?f("Invalid format: write element must be boolean"):b.read&&!e?f("Callback not specified. The callback parameter is mandatory for read operations"):this.connection.subscribe(b,e):f("channel not specified")};
...
typeof b)return BBT.error("Invalid format: limit must be a number");var e=a.callback||d;if(!e)return BBT.error("Callback function not specified");$.get(this.getApiUrl()+"/api/public/resource",{owner:a.owner,channel:a.channel,resource:a.resource,limit:b}).success(function(a){e&&e(null,a)}).error(function(a,b,d){e&&e({code:11,message:"Error"},null)})};
...
function(a,b){var e=this;a.method=a.method.toUpperCase();date=(new Date).toUTCString();contentType="application/json";md5="";if("POST"===a.method||"PUT"===a.method)md5=b64_md5(a.data);beforeSend=function(a){};!0!==a.is_public&&(beforeSend=function(b){md5&&b.setRequestHeader("Content-MD5",md5);b.setRequestHeader("Authorization",e.signRequest(a.method,md5,contentType,"",e.getUriToSign(a.method,a.uri,a.data)));b.setRequestHeader("X-Bbt-Date",(new Date).toUTCString())});$.ajax({url:this.protocol+"://"+
this.hostname+":"+this.port.toString()+a.uri,type:a.method,dataType:"json",data:a.data,contentType:contentType,beforeSend:beforeSend,success:function(a){b(null,a)},error:function(a){b(a,a)}})}};
