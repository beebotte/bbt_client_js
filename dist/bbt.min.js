...
BBT=function(a,d){checkAppKey(a);this.key=a;d=d||{};this.initDefaults();this.updateParams(d);this.instanceID=Math.floor(1E9*Math.random());BBT.instances.push(this);this.connection=new BBT.Connection(this);this.connect()};BBT.VERSION="0.5.1";
