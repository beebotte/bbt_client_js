...
BBT.Channel.prototype.unsubscribe=function(){this.subscribed=!1;this.resetReadPermission();this.resetWritePermission()};BBT.Channel.prototype.hasWritePermission=function(){return this.writePermission};BBT.Channel.prototype.hasReadPermission=function(){return this.readPermission};function checkAppKey(a){null!==a&&void 0!==a||BBT.warn("Warning: You must pass your key id when you instantiate BBT.")}
BBT.warn=function(a){window.console&&(window.console.warn?window.console.warn(a):window.console.log&&window.console.log(a));BBT.log&&BBT.log(a)};BBT.error=function(a){if(BBT.debug)throw Error(msg);};BBT.prototype.setUsername=function(a){this.userinfo.username=a};BBT.prototype.connect=function(){this.connection.connection?(this.connection.connection.socket.options.query="key="+this.key+"&username="+(this.userinfo.username||""),this.connection.connection.socket.reconnect()):this.connection.connect()};
BBT.prototype.disconnect=function(){this.connection.disconnect()};
