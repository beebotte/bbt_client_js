...
BBT.Channel.prototype.do_subscribe=function(){var a=this;if(a.bbt.connection.connected){var d=this.bbt.connection,b={};b.channel=a.channel;b.resource=a.resource||"*";b.ttl=b.ttl||0;b.read=a.read;b.write=a.write;"undefined"!==typeof a.bbt.userinfo&&(b.userinfo=a.bbt.userinfo);if(this.authNeeded()){if(!a.bbt.auth_endpoint)return a.onError("Authentication error: Missing authentication endpoint!");if(d.connected&&d.connection&&d.connection.io.engine.id&&d.connection.io.engine.id)if(b.sid=d.connection.io.engine.id,
